...
public class ViewSaleActivity extends Activity implements OnClickListener{
	
	private static final String TAG="ViewSaleActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.viewsalesscreen);
		context=this;
		...
		progressBar = ProgressDialog.show(ViewSaleActivity.this, "","Loading...");
		...
		webview_help.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
				...
				Toast.makeText(ViewSaleActivity.this, "Oh no! " + description,Toast.LENGTH_SHORT).show();
		...
		webview_help.loadUrl(ImageConstant.VIEWSALE);  // loading url here
