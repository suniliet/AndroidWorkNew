...
public class UploadFileServicePending extends IntentService{
	...
	public UploadFileServicePending() {
		super("name");
		Log.v(TAG, "UploadFileServicePending called");
		//Log.v(TAG, "AutoUploadServiceNotes called");
	   // ePodUtil.epodLog(context, TAG,"AutoUploadServiceNotes called");
	}
	public UploadFileServicePending(String name) {
		super(name);
	...
	public void onCreate() {
		...
		ImageUtil.galleryLog(TAG, "UploadFileServicePending onCreate called");
	}
