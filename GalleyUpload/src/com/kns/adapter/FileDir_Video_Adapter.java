...
public class FileDir_Video_Adapter  extends BaseAdapter{
	...
	public FileDir_Video_Adapter(Activity context, List<FileDirectories> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null ) {
			...
			convertView = mInflater.inflate(R.layout.filedir_video_row, null);
			
			holder.image = (SmartImageView) convertView.findViewById(R.id.imgQueue_dirvideo);
		...
		if (isfile) {
			 VideoThumbnailImage thumb = new VideoThumbnailImage(videoid,  MediaStore.Video.Thumbnails.MICRO_KIND);
			 holder.image.setImage(thumb,R.drawable.ic_dwnloadthumb);
		}
		else{
