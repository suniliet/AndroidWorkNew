...
public class Partner_Image_Adapter1 extends BaseAdapter{
	...
	public Partner_Image_Adapter1(Activity context, List<PartnerImage_Model> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null ) {
			...
			convertView = mInflater.inflate(R.layout.image_view_row1, null);
