...
public class Custom_Video_Adapter extends BaseAdapter{

	private static final String TAG="Custom_Video_Adapter";
	private LayoutInflater mInflater=null;
	private List<Custom_Video_Model> videolist=null;
	private Context context=null;
	private  Bitmap bitmap=null;
	private  Button btn_update;
	private boolean isActionMultiplePick;
	
	public Custom_Video_Adapter(Activity context, List<Custom_Video_Model> list){
	...
	public ArrayList<Custom_Video_Model> getSelected() {
		ArrayList<Custom_Video_Model> dataT = new ArrayList<Custom_Video_Model>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Custom_Video_Model imagemodel=videolist.get(position);
